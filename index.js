...
function analyze(data) {
    ...
    if (latest.ema9 > latest.ema21 && latest.rsi14 > 52 && latest.macd.histogram > 0 && latest.stoch.k > latest.stoch.d && latest.stoch.k > 60) {
        signal = 'STRONG BUY';
    } else if (latest.ema9 > latest.ema21 && latest.rsi14 > 50 && latest.macd.histogram > -0.0001 && latest.stoch.k > latest.stoch.d) {
        signal = 'BUY';
    } else if (latest.ema9 < latest.ema21 && latest.rsi14 < 50 && latest.macd.histogram < 0 && latest.stoch.k < latest.stoch.d) {
        signal = 'SELL';
    } else if (latest.ema9 < latest.ema21 && latest.rsi14 < 48 && latest.macd.histogram < -0.0001 && latest.stoch.k < latest.stoch.d && latest.stoch.k < 40) {
        signal = 'STRONG SELL';
    }
